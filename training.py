...
def network(hidden_size = 100, weight_decay_lambda = 0):
    ...
    net_12x12 = NeuralNet1(12, 6, (3,2,2,1,0), hidden_size, weight_decay_lambda)
    net_10x10 = NeuralNet1(10, 5, (2,2,1,1,0), hidden_size, weight_decay_lambda)
...
def train(net, size, train_data, test_data, iter_num = 10000, _batch_size = 100, learning_rate = 0.01, _iter_per_epoch = 20):
